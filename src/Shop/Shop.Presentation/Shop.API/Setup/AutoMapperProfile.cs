...
public class AutoMapperProfile : Profile
{
    public AutoMapperProfile()
    {
        ...
        CreateMap<CreateInventoryCommand, CreateInventoryViewModel>().ReverseMap();
        CreateMap<DecreaseInventoryQuantityCommand, DecreaseInventoryQuantityViewModel>().ReverseMap();
        CreateMap<EditInventoryCommand, EditInventoryViewModel>().ReverseMap();
        CreateMap<IncreaseInventoryQuantityCommand, IncreaseInventoryQuantityViewModel>().ReverseMap();
        CreateMap<SetInventoryDiscountPercentageCommand, SetInventoryDiscountPercentageViewModel>().ReverseMap();
