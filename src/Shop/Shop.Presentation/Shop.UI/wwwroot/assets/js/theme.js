(function ($)
{
  ...
  HAMTA.StickyHeader = function ()
  {
    ...
    const navWrapperHeight = $(".page-header .nav-wrapper").height();
  ...
  HAMTA.Quantity = function ()
  {
    ...
    {
      const $input = $(this).parents(".num-block").find("input.in-num");
      ...
      {
        const count = parseFloat($input.val()) + 1;
        $input.val(count);
  ...
  HAMTA.FilterPrice = function ()
  {
    ...
    {
      const skipSlider = document.getElementById("slider-non-linear-step");
  ...
  HAMTA.ColorSwitcher = function ()
  {
    if ($("#colorswitch-option").length)
    {
      ...
      $("#colorswitch-option ul li").on("click", function ()
      {
        ...
        const colorPath = $(this).attr("data-path");
